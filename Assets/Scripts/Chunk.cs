...
{
    // Holds new vertices, 6 surfaces 4 each
    private List<Vector3> newVertices = new List<Vector3>();

    // Triangles: how to build each mesh(textures, colliders, etc) to connect with vertices
    private List<int> newTriangles = new List<int>();

    // How texture aligns on polygon
    ...
    // Textures 
    private Vector2 grassTop = new Vector2(1, 11); //position on .tga
    ...
    // called everytime surface is created
    // adds arrays to mesh
    void UpdateMesh()
    {
        mesh.Clear();
    ...
    {
        // Adds 4 points to vertices array
    ...
    void CubeNorth(int x, int y, int z, byte block)
    {
        ...
        Vector2 texturePos = SetSides(x, y, z, block);
    ...
    public Vector2 SetSides(int x, int y, int z, byte block)
    {
        Vector2 texturePos = new Vector2(0, 0);
